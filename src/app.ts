...
import safariEssentialsRoutes from './routes/safari-essentials.routes';
...
import guestDetailsRoutes from './routes/guest-details.routes';
import lodgeImagesRoutes from './routes/lodge-images.routes';
...
import marketPagesRoutes from './routes/market-pages.routes';
...
app.use('/api/guest-details', guestDetailsRoutes);
app.use('/api/lodge-images', lodgeImagesRoutes);
...
app.use('/api/safari-essentials', safariEssentialsRoutes);
...
app.use('/api/market-pages', marketPagesRoutes);
